...
//     // function testGetAllRestaurantOwners() public {
//     //     string memory name1 = "Restaurant #1";
//     //     rf.createRestaurant(name1);
//     //     string memory name2 = "Restaurant #2";
//     //     rf.createRestaurant(name2);
//     //     assertEq(, rf.);
//     // }
...
//     //     // Call getRestaurantBytes and retrieve the bytes of the restaurant contract
//     //     bytes memory restaurantBytes = rf.getRestaurantBytes(restaurantAddr);

//     //     // Assert that the retrieved bytes is not empty
//     //     assertGt(restaurantBytes.length, 0);
//     // }
